                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-3 form-group mb-3">
                            ...
                            <input type="number" inputmode="numeric" name="nik" id="nik" class="form-control" value="{{ old('nik')}}">
                        </div>
                        <div class="col-3 form-group mb-3">
                    ...
                    <div class="row">
                        <div class="col-3 form-group mb-3">
                            ...
                            <input type="number" inputmode="numeric" name="phone" id="phone" class="form-control" value="{{ old('phone')}}">
                        </div>
                        <div class="col-6 form-group mb-3">
                        ...
                        <div class="col-3 form-group mb-3">
                            ...
                            <select name="asn_type" id="asn_type" class="form-control">
                                @foreach ([
                                    ...
                                    <option value="{{ $item->value }}" @selected(old('asn_type') == $item->value)>{{ $item->label }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div id="NIP" class="col-3 form-group mb-3">
                            <label id="labelNIP" for="nip">NIP</label>
                        ...
                        <div class="col-3 form-group mb-3">
                            ...
                            <select name="pangkat" id="pangkat" class="form-control">
                                @foreach ($pangkats as $item)
                                    <option value="{{ $item->name }}" @selected(old('pangkat') == $item->name)>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-6 form-group mb-3">
                            ...
                            is-invalid @enderror" value="{{ old('jobdesc') }}">
                            @error('jobdesc')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                        ...
                        <label for="placement">Penempatan</label>
                            <select name="placement" id="placement" class="form-control">
                                @foreach ([
                                    ...
                                    <option value="{{ $item->value }}" @selected(old('placement') == $item->value)>{{ $item->label }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-3 form-group mb-3">
                            ...
                            <select name="education" id="education" class="form-control">
                                @foreach ([
                                    ...
                                    <option value="{{ $item->value }}" @selected(old('education') == $item->value)>{{ $item->label }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-6 form-group mb-3">
